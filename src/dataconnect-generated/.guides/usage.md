...
```ts
import { useGetPublicProjects, useGetMySkills, useCreateNewProject, useUpdateUserBio } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useGetPublicProjects();

const { data, isPending, isSuccess, isError, error } = useGetMySkills();
...
```js
import { getPublicProjects, getMySkills, createNewProject, updateUserBio } from '@dataconnect/generated';
